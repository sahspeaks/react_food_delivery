  ...
  return (
    <motion.div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 ">
      <div className="flex flex-col items-start justify-start gap-6 ">
        ...
        <p className="text-[40px] text-headingColor md:text-[54px] font-sans font-bold tracking-wider -my-4">
          Craving authentic flavours ?{" "}
          <span className="text-orange-600">Try Homemade Haven</span>
        </p>

        <p className="text-textColor text-lg">
          Are you tired of compromising on the quality of your meals due to your
          hectic schedule? Do you long for the taste of authentic, homemade food
          ? Look no further than “Homemade Haven” that brings skilled homemakers
          and busy professionals together.
        </p>
        <Link to={"/menu"}>
          <motion.button
            {...buttonClick}
